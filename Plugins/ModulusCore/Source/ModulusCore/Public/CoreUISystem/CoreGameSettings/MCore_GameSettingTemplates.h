...
class MODULUSCORE_API UMCore_GameSettingTemplates : public UObject
{
    ...
    {
        FMCore_SettingsConfiguration Config;
        
        Config.Categories.Add(CreateDisplaySettings());
        Config.Categories.Add(CreateGraphicsSettings());
        Config.Categories.Add(CreateAudioSettings());
        Config.Categories.Add(CreateControlsSettings());
        Config.Categories.Add(CreateAccessibilitySettings());
    ...
    UFUNCTION(BlueprintCallable, CallInEditor, Category = "Modulus Settings|Templates")
    static FMCore_SettingsConfiguration CreateCustomConfiguration(const TArray<FMCore_SettingCategory>& Categories)
    {
        FMCore_SettingsConfiguration Config;
